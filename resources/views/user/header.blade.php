...
<!-- Mirrored from themewagon.github.io/gotrip/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Oct 2023 08:15:22 GMT -->
<!-- Added by HTTrack -->
                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-1">
                            <div class="logo">
                                <a href="index.blade.php"><img src="{{asset('user/assets/img/logo/logo.png')}}" alt=""></a>
                            </div>
                        </div>
