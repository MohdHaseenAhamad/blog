...
<!-- Mirrored from themepixels.me/demo/bracket/app/signup-simple.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 30 Sep 2023 06:17:18 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
<form method="POST" action="{{url('admin/register/save')}}">
    @csrf
