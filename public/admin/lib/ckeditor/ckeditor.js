...
(function () {
    ...
    (function () {
        var a = [], e = CKEDITOR.env.gecko ? "-moz-" : CKEDITOR.env.webkit ? "-webkit-" : CKEDITOR.env.ie ? "-ms-" : "",
            b = /&/g, c = />/g, f = /</g, d = /"/g, g = /&amp;/g, h = /&gt;/g, m = /&lt;/g, j = /&quot;/g;
    ...
    CKEDITOR.dtd = function () {
        var a = CKEDITOR.tools.extend, e = function (a, f) {
                ...
                table: 1,
                ul: 1
            }, d = {command: 1, link: 1, meta: 1, noscript: 1, script: 1, style: 1}, g = {}, h = {"#": 1},
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            getDocumentPosition: function (a) {
                ...
                if (document.documentElement.getBoundingClientRect) {
                    var p =
                            this.$.getBoundingClientRect(), u = c.$.documentElement, t = u.clientTop || e.$.clientTop || 0,
                        y = u.clientLeft || e.$.clientLeft || 0, n = true;
                    if (CKEDITOR.env.ie) {
    ...
    (function () {
        function a(a, b) {
            ...
            d = c.endContainer;
            var e = c.startOffset, p = c.endOffset, i, k = this.guard, l = this.type,
        ...
        var d = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, g = CKEDITOR.dom.walker.whitespaces(),
            h = CKEDITOR.dom.walker.bookmark(), m = CKEDITOR.dom.walker.temp();
        ...
        CKEDITOR.dom.range.prototype =
            {
                ...
                getBoundaryNodes: function () {
                    ...
                    switch (a) {
                        ...
                        case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                            ...
                            var J, A,
                                E = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {br: 1} : null),
                                v = null, z = function (a) {
                    ...
                    if (!this.collapsed) {
                        var a = a || CKEDITOR.SHRINK_TEXT, d = this.clone(), f = this.startContainer,
                            e = this.endContainer, o = this.startOffset, g = this.endOffset, i = 1, k = 1;
                ...
                setEndAt: function (a, b) {
                    ...
                    var b = new CKEDITOR.dom.elementPath(this.startContainer, this.root),
                        c = new CKEDITOR.dom.elementPath(this.endContainer, this.root), d = b.block, f = c.block,
                        e = null;
    ...
    (function () {
        ...
        var d = /^[\r\n\t ]+$/, g = CKEDITOR.dom.walker.bookmark(false, true),
            h = CKEDITOR.dom.walker.whitespaces(true), m = function (a) {
                return g(a) && h(a)
            }, j = {dd: 1, dt: 1, li: 1};
        a.prototype = {
    ...
    (function () {
        ...
        CKEDITOR.filter.prototype = {
            allow: function (b, c, f) {
                ...
                var f = this, e = [], i = this.editor && this.editor.config.protectedSource, q, k = false,
                    B = {doFilter: !c, doTransform: true, doCallbacks: true, toHtml: b};
                a.forEach(function (a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) {
        ...
        var v = {styles: 1, attributes: 1, classes: 1},
            z = {styles: "requiredStyles", attributes: "requiredAttributes", classes: "requiredClasses"},
            B = /^([a-z0-9*\s]+)((?:\s*\{[!\w\-,\s\*]+\}\s*|\s*\[[!\w\-,\s\*]+\]\s*|\s*\([!\w\-,\s\*]+\)\s*){0,3})(?:;\s*|$)/i,
            D = {styles: /{([^}]+)}/, attrs: /\[([^\]]+)\]/, classes: /\(([^\)]+)\)/}, G = /^cke:(object|embed|param)$/,
        ...
        CKEDITOR.lang = {
            languages: {
                ...
                var b = this.languages, e = e || navigator.userLanguage || navigator.language || a,
                    c = e.toLowerCase().match(/([a-z]+)(?:-([a-z]+))?/), f = c[1], c = c[2];
        ...
        CKEDITOR.htmlParser.fragment.fromHtml =
            function (d, g, h) {
                ...
                var n = new CKEDITOR.htmlParser,
                    ...
                    o = [], r = [], i = w, k = w.name == "textarea", l = w.name == "pre";
        ...
        a.prototype = {
            add: function (a, c, f) {
                ...
                var f = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment,
                    d = Array.prototype.slice.call(arguments, 1), e = this.rules, h = e.length, m, j, p, u;
                for (u = 0; u < h; u++) {
                    if (f) {
                        m = c.type;
                        j = c.name
    ...
    (function () {
        ...
        CKEDITOR.htmlDataProcessor = function (b) {
            ...
            b.on("toHtml", function (a) {
                    var a = a.data, c = a.dataValue, c = w(c, b), c = p(c, J), c = j(c), c = p(c, Q),
                        c = c.replace(E, "$1cke:$2"), c = c.replace(z, "<cke:$1$2></cke:$1>"),
                        c = c.replace(/(<pre\b[^>]*>)(\r\n|\n)/g, "$1$2$2"),
        ...
        var o = /(?:&nbsp;|\xa0)$/, r = "{cke_protected}", i = CKEDITOR.dtd,
            k = ["caption", "colgroup", "col", "thead", "tfoot", "tbody"],
            l = CKEDITOR.tools.extend({}, i.$blockLimit, i.$block), q = {elements: {input: h, textarea: h}},
        ...
        var R = /<(a|area|img|input|source)\b([^>]*)>/gi,
            N = /([\w-]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, F = /^(href|src|name)$/i,
            Q = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi,
            J = /(<textarea(?=[ >])[^>]*>)([\s\S]*?)(?:<\/textarea>)/gi, A = /<cke:encoded>([^<]*)<\/cke:encoded>/gi,
            E = /(<\/?)((?:object|embed|param|html|body|head|title)[^>]*>)/gi,
            v = /(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi, z = /<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi
    })();
    "use strict";
    ...
    (function () {
        ...
        CKEDITOR.editor.prototype.resize = function (a, b, d, e) {
            var h = this.container, m = this.ui.space("contents"),
                ...
                focus: function () {
                    ...
                    if (!this.is("textarea")) {
                        ...
                        this.attachListener(a, "key", function (b) {
                            ...
                            if (c in l) {
                                var b = a.getSelection(), f, i = b.getRanges()[0], k = i.startPath(), g, h, j,
                                    c = c == 8;
            ...
            getNative: function () {
                ...
                var b = this, c = CKEDITOR.tools.tryThese(function () {
                    ...
                    for (var a = b.getRanges()[0].clone(), c, d, e = 2; e && (!(c = a.getEnclosedNode()) ||
                        !(c.type == CKEDITOR.NODE_ELEMENT && r[c.getName()] && (d = c))); e--) a.shrink(CKEDITOR.SHRINK_ELEMENT);
                    return d && d.$
                });
    ...
    (function () {
        ...
        function t(a, b) {
            var c = this._.definition,
                d = c.attributes, c = c.styles, e = k(this)[a.getName()],
        ...
        var x = {
            ...
            }, s =
                {
                    ...
                    audio: 1,
                    video: 1
                }, M = /\s*(?:;\s*|$)/, R = /#\((.+?)\)/g, N = CKEDITOR.dom.walker.bookmark(0, 1),
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.text.prototype, {
        type: CKEDITOR.NODE_TEXT, getLength: function () {
            ...
            var e = this.$.parentNode, b = e.childNodes.length, c = this.getLength(), f = this.getDocument(),
    ...
    (function () {
        function a(a, c, e) {
            var d = a.serializable, g = c[e ? "endContainer" : "startContainer"], h = e ? "endOffset" : "startOffset",
...
*/
    ...
    CKEDITOR.plugins.add("colorbutton", {
        requires: "panelbutton,floatpanel", init: function (c) {
            ...
            function q(m, g, d) {
                var h = [], i = j.colorButton_colors.split(","),
                    k = c.plugins.colordialog && !1 !== j.colorButton_enableMore, a = i.length + (k ? 2 : 1),
    ...
    (function () {
        ...
        var j = CKEDITOR.dtd.$listItem, l = CKEDITOR.dtd.$list, f = CKEDITOR.TRISTATE_DISABLED,
    ...
    (function () {
        ...
        function y(c, j, e) {
            ...
            j.trim(!1, !0);
            var k = j.createBookmark(), g = new CKEDITOR.dom.elementPath(j.startContainer), h = g.block,
        ...
        CKEDITOR.plugins.add("pagebreak", {
            requires: "fakeobjects", onLoad: function () {
                ...
                var c = a.dataProcessor, g = c && c.dataFilter, c = c && c.htmlFilter,
                    h = /page-break-after\s*:\s*always/i, i = /display\s*:\s*none/i;
                c && c.addRules({
                    attributes: {
                        "class": function (a, b) {
    ...
    (function () {
        var h, i = {
            modes: {wysiwyg: 1, source: 1}, canUndo: !1, readOnly: 1, exec: function (a) {
                ...
                d = 80;
                try {
                    var c = window.screen, f = Math.round(0.8 * c.width), b = Math.round(0.7 * c.height),
        ...
        CKEDITOR.plugins.add("showblocks", {
            onLoad: function () {
                var a = "p div pre address blockquote h1 h2 h3 h4 h5 h6".split(" "), c, b, e, f,
                    i = CKEDITOR.getUrl(this.path), j = !(CKEDITOR.env.ie &&
                    9 > CKEDITOR.env.version), g = j ? ":not([contenteditable=false]):not(.cke_show_blocks_off)" : "",
                    d, h;
        ...
        requires: "menubutton,dialog", tabToOpen: null, dialogName: "scaytDialog", init: function (a) {
            ...
            a.plugins.wsc && (b.WSC = {
                label: a.lang.wsc.toolbar, group: "scaytButton", onClick: function () {
                    var c = CKEDITOR.plugins.scayt, b = a.scayt,
            ...
            var d = a.dataProcessor, c = d && d.htmlFilter, b = a._.elementsPath && a._.elementsPath.filters,
                d = d && d.dataFilter, f = a.addRemoveFormatFilter, g = function (c) {
            ...
            !b[e].verification(a) && delete f[e], a.addCommand(e, {exec: b[e].exec}), a.addMenuItem(e, {
        ...
        if (!0 === CKEDITOR.config.scayt_handleCheckDirty) {
            ...
            a.checkDirty = CKEDITOR.tools.override(a.checkDirty, function (a) {
                return function () {
                    ...
                    if (!CKEDITOR.plugins.scayt || !CKEDITOR.plugins.scayt.state[this.name] || !this.scayt) b = a.call(this); else if (b = "ready" == this.status) var g = d.removeMarkupFromString(this.getSnapshot()),
                        d = d.removeMarkupFromString(this._.previousValue), b = b && d !== g;
                    return b
                }
            });
